...
**Versão:** 1.4 (avaliação interna — `2026-05`) — sincroniza M1, M2, M3 e M5 com as planilhas Excel canônicas e refatora o gerador de PDF unificado. Destaques: (a) corrige sinal do Diferencial Relativo e fórmula da "Força do Argumento" no M5; (b) reestrutura o levantamento de custos do PSC (M1 e M5) para cobrir os 13 itens-tipo de OPEX e os 7 de Gestão da planilha; (c) integra "Custos de Transação" como item C6 em Gestão; (d) restaura textos integrais do catálogo de riscos (M2) e amplia o glossário; (e) adiciona blocos canônicos faltantes nas Instruções do M3 e auto-populações na Justificativa 5.1; (f) reescreve o "PDF unificado" para usar uma janela popup dedicada — o navegador recebia o conteúdo dos iframes truncado quando imprimíamos no shell; agora a popup monta o documento consolidado e dispara o print de forma confiável (Chrome/Edge testados). Requer permissão de popups deste site.
